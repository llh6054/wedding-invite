...
document.querySelector('.address-sunrise').addEventListener('click',()=>{
    wx.openLocation({
        latitude: 24.904389, // 纬度，浮点数，范围为90 ~ -90
        longitude: 114.815049, // 经度，浮点数，范围为180 ~ -180。
        name: '龙南市凯里亚德酒店', // 位置名
        address: '凯里亚德酒店(赣州龙南世界客家民俗文化城店)--金水大道500号', // 地址详情说明
...
document.querySelector('.address-res').addEventListener('click',()=>{
    wx.openLocation({
        latitude: 24.633121, // 纬度，浮点数，范围为90 ~ -90
        longitude: 114.645251, // 经度，浮点数，范围为180 ~ -180。
        name: '杨太村委会', // 位置名
        address: '赣州市龙南市杨村镇杨太村马坪祖厅--杨太村委会进入内部路沿马路直行三百米', // 地址详情说明
        scale: 15, // 地图缩放级别,整型值,范围从1~28。默认为最大
        infoUrl: 'https://map.baidu.com/poi/%E9%BE%99%E5%8D%97%E5%8E%BF%E6%9D%A8%E6%9D%91%E9%95%87%E6%9D%A8%E5%A4%A7%E6%9D%91%E6%B0%91%E5%A7%94%E5%91%98%E4%BC%9A/@12762936.515,2813383.99,19z?uid=745e06ae13e510e7932ca3fe&info_merge=1&isBizPoi=false&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&querytype=detailConInfo&da_src=shareurl' // 在查看位置界面底部显示的超链接,可点击跳转
    });
})
